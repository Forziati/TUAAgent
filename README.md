...
└── db/
    ...
    └── gap_full_history.json    # Serie histórica completa de GAP (2016-2026)
```
...
- **Aeropuertos**: los 10 reales por volumen de pasajeros (AICM, Cancún,
  ...
  AIFA, Del Bajío).
- **TUA**: cargada para 8 de los 10 (faltan Puerto Vallarta y Del
  Bajío — para Puerto Vallarta solo hay un oficio de 2021 claramente
  desactualizado, se prefirió no cargarlo). Monterrey y Mérida tienen
  valores exactos y oficiales (Diario Oficial de la Federación / marzo
  2026 respectivamente).
- **Tráfico de pasajeros**: 694 filas reales, de 4 fuentes oficiales:
  - **gob.mx** (SICT/AFAC/DT): dic-2022 y dic-2023, los 10 aeropuertos.
  - **GAP**: serie MENSUAL COMPLETA de **mayo 2016 a mayo 2026** (125
    meses, ~10 años) para Guadalajara, Tijuana, Los Cabos, Puerto
    Vallarta y Del Bajío. Compilada por el alumno a partir de los
    reportes mensuales en PDF de GAP.
  - **ASUR**: serie completa ene-jul 2025/2026 para Cancún y Mérida.
  - **OMA (Excel oficial)**: serie mensual completa de Monterrey,
    2024 a jul-2026 (2024 y 2025 con los 12 meses cada uno).
  - **AICM y AIFA no tienen fuente mensual pública** con el mismo
    detalle — solo cuentan con dic-2022 y dic-2023.
  - Los 5 aeropuertos de GAP tienen ahora 10 años de historia
    **completa**, lo que hace que la proyección por quinquenio sea
    mucho más confiable en esos casos que en el resto.
...
tienen los 12 meses cargados — un año parcial (ej. solo diciembre)
se excluye automáticamente, porque su total se parece al de un mes,
no al de un año, y distorsiona la recta. El total de cada quinquenio
se calcula sumando la predicción año por año (no repitiendo el valor
de un solo año 5 veces). El dashboard muestra qué años quedaron
afuera del cálculo para cada aeropuerto.
...
2. **Completar Cancún, Mérida y Monterrey** con más años históricos,
   igual que se hizo con GAP, si aparece una fuente similar.
